...
// based off of https://youtu.be/--LB7URk60A
// && https://youtu.be/x_CfGJh17Z8 https://github.com/Radishmouse22/UILineRenderer
// TODO: Figure out how to call SetAllDirty() when endTransform moves
[RequireComponent(typeof(CanvasRenderer))]
public class UiLineSegment : Graphic // MaskableGraphic
{
    [Tooltip("Must share the same parent and not utilize anchoring")]
    ...
    protected override void OnPopulateMesh(VertexHelper vh)
    {
        ...
        {
            endPoint = endTransform.localPosition - startTransform.localPosition;
        }

        CreateIsoTriangle(startPoint, endPoint, vh);
    ...
    private void CreateIsoTriangle(Vector3 point1, Vector3 point2, VertexHelper vh)
    {
